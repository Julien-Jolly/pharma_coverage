...
def get_pharmacies_in_subarea(center_lat, center_lon, radius=500):
    pharmacies = []
...
def get_pharmacies_in_area(lat_min, lat_max, lon_min, lon_max, subarea_step=0.005, subarea_radius=500):
    pharmacies = []
    total_requests = 0
...
def main():
    ...
    pharmacies, total_requests = get_pharmacies_in_area(lat_min, lat_max, lon_min, lon_max, subarea_step=0.005,
                                                        subarea_radius=500)
    if not pharmacies:
